...
<div class="bg-white p-6 rounded-lg shadow-md">
    ...
    <form action="{{ route('categoryAdmin.store') }}" method="POST">
        ...
        <div class="mb-4">
            ...
            <input type="text" id="kategori" name="kategori" value="{{ old('kategori') }}" class="w-full p-2 border border-gray-300 rounded-lg">
            @error('kategori')
        ...
        <div class="mb-4">
            ...
            <textarea id="kode_rak" name="kode_rak" class="w-full p-2 border border-gray-300 rounded-lg">{{ old('kode_rak') }}</textarea>
            @error('kode_rak')
                <div class="text-red-500 bg-red-100 border border-red-400 rounded-md p-2 mt-2">
                    {{ $message }}
                </div>
