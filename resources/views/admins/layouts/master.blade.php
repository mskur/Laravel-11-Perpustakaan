    ...
    <div class="flex min-h-screen">
        ...
        <div id="sidebar" class="sidebar sidebar-expanded bg-white h-screen shadow-md fixed top-0 left-0 h-full overflow-y-auto">
            ...
            <nav class="mt-10">
                ...
                <a href="{{ route('loansAdmin.index') }}" 
                class="flex items-center py-2 px-8 {{ Request::routeIs('loansAdmin.index', 'loansAdmin.create', 'loansAdmin.edit') ? 'bg-gray-200 text-gray-700 md:font-bold' : 'text-gray-600 hover:bg-gray-100' }}">
        ...
        <div class="main-content flex-1 p-6 ml-64 overflow-auto transition-all duration-300">
            ...
            <div class="flex justify-between items-center mb-6">
                ...
                <div class="flex items-center relative">
                    <div class="ml-4">
                        <span class="ml-2 text-gray-700">{{ session('nama_admin') }}</span>
                    </div>
                    <div class="ml-4 relative">
                        <button onclick="toggleProfileMenu()" class="focus:outline-none">
                            <img src="https://storage.googleapis.com/a1aa/image/h__Rghuk2luwEjzc8MyT_UQwtaSebVvIfQL3J1_VCB4.jpg" alt="User Avatar" class="h-10 w-10 rounded-full">
                        </button>
                        <div id="profileMenu" class="hidden absolute right-0 mt-2 w-48 bg-white rounded-md shadow-lg py-1 z-20">
                            <a href="{{ route('getAdmin') }}" class="block px-4 py-2 text-gray-700 hover:bg-gray-100">Profile</a>
                            <a href="{{ route('logoutAdmin') }}" class="block px-4 py-2 text-gray-700 hover:bg-gray-100">Logout</a>
                        </div>
                    </div>
                </div>
            </div>
